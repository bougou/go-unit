...
| Option | Effect |
|--------|--------|
| `WithSpace(true)` | Space between number and prefix (`"1 Mi"`) |
| `WithPrecision(n)` | Fixed decimal places |
...
For **byte** multiples with named constants (`KB`, `KiB`, …), see [Byte constants](../byte-constants/).
